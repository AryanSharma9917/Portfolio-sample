...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      I’m Aryan, currently I live in India working as a OpenSource Contributor{' '}
      {/* <Link href="https://www.github.com/Aryansharma9917">Qwilr</Link>. My projects include UX design, UI
